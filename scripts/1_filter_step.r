...
#The Population Genetics and Genomics in R Primer (https://grunwaldlab.github.io/Population_Genetics_in_R/index.html) was referenced. The unfiltered VCF file and metadata table are also available.  
...
pass.vcf = read.vcfR("passalora_4_2.vcf")
