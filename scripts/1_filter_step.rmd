...
Code is adapted from tutorials from https://grunwaldlab.github.io/Population_Genetics_in_R/index.html.The unfiltered vcf file is in the
'data' folder. 
...
Obtain information about % missing data for each sample. This is useful for determining which of the technical replicates to retain or disgard in the final analysis
```{r, eval=TRUE, include=TRUE}
myMiss <- apply(dp, MARGIN = 2, function(x){ sum(is.na(x)) })
