...
Code is adapted from tutorials from https://grunwaldlab.github.io/Population_Genetics_in_R/index.html. The input file is a vcf file obtained from one's preferred variant caller of choice. The unfiltered vcf file is in the 'data' folder. 
